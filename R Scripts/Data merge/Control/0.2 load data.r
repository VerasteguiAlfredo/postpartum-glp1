...
load_sas_safe("weight_controls.sas7bdat",                "weight_controls")

# Cohort & demographics
load_sas_safe("cohort_controls.sas7bdat",                "cohort_controls")
load_sas_safe("demo_controls.sas7bdat",                  "demo_controls")
load_sas_safe("patient_list_controls.sas7bdat",          "patient_list_controls")
...
load_sas_safe("ordered_meds_controls.sas7bdat",          "ord_meds_controls")
load_sas_safe("smoking_controls.sas7bdat",               "smoking_controls")
...
data_list_controls <- mget(
  c("alc_flow_controls", "alc_ppi_controls", "alc_sdoh_controls",
    ...
    "height_controls", "weight_controls", "cohort_controls", "demo_controls",
    "patient_list_controls", "dx_controls", "labs_controls", "ob_controls",
    "ord_meds_controls", "smoking_controls", "echo_ef_controls"),
  envir = .GlobalEnv
)
